var messages = {
  ...
  stop: {
    msg: "Listening stopped, please click on the microphone icon to restart",
    class: "alert-success",
  },
  copy: {
...
document.addEventListener("DOMContentLoaded",function(){
  ...
  if(!("webkitSpeechRecognition" in window)){
    ...
    showInfo("start");
    ////webkitSpeechRecognition is an API to turn spoken text into speech.
    ...
    recognition.onstart = function(){
      recognizing=true;
      showInfo("speak_now");
      start_img.src = 'images/animation.gif'
    }
    ...
    recognition.onend = function(event){
      ...
      start_img.src = "images/normal mic.jpg";
      if(!final_transcript){
        showInfo("start");
        return;
      }
